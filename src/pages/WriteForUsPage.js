    ...
    <Container maxWidth="md" sx={{ py: 8 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Typography paragraph>
          Are you passionate about food, technology, health, or the science behind what we eat? At Food Technology Labs, we are always on the lookout for fresh, informative, and innovative content to share with our audience. Whether you're a food scientist, nutritionist, chef, or an enthusiastic food blogger, we welcome you to join our community of contributors!
        </Typography>
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            <Typography paragraph>
              We publish articles that inform, inspire, and provide value to our readers. We are especially interested in topics that align with our mission and cover areas such as:
            </Typography>
            <List>
              {[
            ...
            <Typography>
              We also welcome how-to guides, in-depth research, case studies, and opinion pieces related to food science and the food industry.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography paragraph>
              To maintain high-quality, valuable content for our readers, we ask that submissions meet the following guidelines:
            </Typography>
            <List>
              {[
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography paragraph>
              To submit an article for consideration, please email us at foodtechnologylabs@gmail.com with the following:
            </Typography>
            <List>
              {[
            ...
            <Typography paragraph>
              Our editorial team will review your submission and respond within 1-2 weeks. Please note that we reserve the right to edit submissions for clarity, tone, and formatting. If your article is accepted, we'll notify you before it goes live.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography variant="h6">Why Write for Food Technology Labs?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <List>
              {[
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 4 }}>
          Thank you for considering Food Technology Labs as a platform for your work. Let's inspire and educate together!
        </Typography>
      </Paper>
    </Container>
  );
