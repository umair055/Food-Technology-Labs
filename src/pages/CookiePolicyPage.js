  ...
  const cookiePolicyItems = [
    {
      ...
      content: (
        <Typography paragraph>
          ...
          They help websites recognize users and remember information to improve user experience, provide personalized content, 
    ...
    },
    {
      ...
      content: (
        <>
          <Typography paragraph>We use cookies for several purposes, including:</Typography>
          <List>
            <ListItem>
              <ListItemText
    ...
    },
    {
      ...
      content: (
        <Typography paragraph>
          Some cookies are placed by third-party providers on our website, such as advertising networks, 
          social media platforms, and analytics services. These third parties may use cookies to gather data 
          on your browsing habits to deliver targeted ads on our site or across other websites.
          <br /><br />
          Please note that we do not control these third-party cookies and recommend reviewing the respective 
          privacy policies of these providers for further details on their practices.
        </Typography>
      )
    },
    {
      ...
      content: (
        <>
          <Typography paragraph>
            You have the option to accept or reject cookies on our website. When you first visit FoodTechnologyLabs.com, 
            you will see a cookie consent banner that allows you to manage your preferences.
          </Typography>
          <Typography paragraph>
            You can also adjust your browser settings to block or delete cookies. Here's how to manage cookies in popular browsers:
          </Typography>
          <List>
            <ListItem>
              <ListItemText
    ...
    },
    {
      ...
      content: (
        <Typography paragraph>
          ...
          Any updates will be posted on this page with the effective date.
        </Typography>
      )
    },
    {
      ...
      content: (
        <Typography paragraph>
          If you have any questions or concerns about our use of cookies, please feel free to reach out to us.
          <br /><br />
          By continuing to use our website without adjusting your browser settings, you agree to our use of 
      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="subtitle1" color="text.secondary">
            At Food Technology Labs, we use cookies and similar tracking technologies to enhance your experience
          </Typography>
        </Box>
